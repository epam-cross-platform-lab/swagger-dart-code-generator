...
abstract class SomeFileName extends ChopperService {
  ...
  Future<chopper.Response<List<Pet>>> petFindByStatusGet({
    ...
    return _petFindByStatusGet(
        status: petFindByStatusGetStatusListToJson(status), cacheControl: cacheControl?.toString());
  }
  ...
  Future<chopper.Response<List<Pet>>> petFindByTagsGet({
    ...
    return _petFindByTagsGet(tags: tags, cacheControl: cacheControl?.toString());
  }
  ...
  Future<chopper.Response<Pet>> petPetIdGet({
    ...
    return _petPetIdGet(
        petId: petId, apiKey: apiKey?.toString(), cacheControl: cacheControl?.toString());
  }
  ...
  Future<chopper.Response> petPetIdPost({
    ...
    return _petPetIdPost(
        petId: petId, name: name, status: status, cacheControl: cacheControl?.toString());
  }
  ...
  Future<chopper.Response> petPetIdDelete({
    ...
    return _petPetIdDelete(
        apiKey: apiKey?.toString(), petId: petId, cacheControl: cacheControl?.toString());
  }
  ...
  Future<chopper.Response<Object>> storeInventoryGet({
    ...
    return _storeInventoryGet(apiKey: apiKey?.toString(), cacheControl: cacheControl?.toString());
  }
  ...
  Future<chopper.Response<Order>> storeOrderOrderIdGet({
    ...
    return _storeOrderOrderIdGet(orderId: orderId, cacheControl: cacheControl?.toString());
  }
  ...
  Future<chopper.Response> storeOrderOrderIdDelete({
    ...
    return _storeOrderOrderIdDelete(orderId: orderId, cacheControl: cacheControl?.toString());
  }
  ...
  Future<chopper.Response> userCreateWithArrayPost({
    ...
    return _userCreateWithArrayPost(body: body, cacheControl: cacheControl?.toString());
  }
  ...
  Future<chopper.Response> userCreateWithListPost({
    ...
    return _userCreateWithListPost(body: body, cacheControl: cacheControl?.toString());
  }
  ...
  Future<chopper.Response<String>> userLoginGet({
    ...
    return _userLoginGet(
        username: username, password: password, cacheControl: cacheControl?.toString());
  }
  ...
  Future<chopper.Response<User>> userUsernameGet({
    ...
    return _userUsernameGet(username: username, cacheControl: cacheControl?.toString());
  }
  ...
  Future<chopper.Response> userUsernamePut({
    ...
    return _userUsernamePut(username: username, body: body, cacheControl: cacheControl?.toString());
  }
  ...
  Future<chopper.Response> userUsernameDelete({
    ...
    return _userUsernameDelete(username: username, cacheControl: cacheControl?.toString());
  }
...
enums.OrderStatus orderStatusFromJson(
  ...
  return enums.OrderStatus.values.firstWhereOrNull(
          (e) => e.value.toString().toLowerCase() == orderStatus?.toString().toLowerCase()) ??
      defaultValue ??
...
enums.PetStatus petStatusFromJson(
  ...
  return enums.PetStatus.values.firstWhereOrNull(
          (e) => e.value.toString().toLowerCase() == petStatus?.toString().toLowerCase()) ??
      defaultValue ??
...
enums.PetFindByStatusGetStatus petFindByStatusGetStatusFromJson(
  ...
  return enums.PetFindByStatusGetStatus.values.firstWhereOrNull((e) =>
          e.value.toString().toLowerCase() == petFindByStatusGetStatus?.toString().toLowerCase()) ??
      defaultValue ??
