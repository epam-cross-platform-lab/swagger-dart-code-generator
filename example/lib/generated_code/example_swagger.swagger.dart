...
abstract class ExampleSwagger extends ChopperService
{
  static ExampleSwagger create([ChopperClient client]) {
	...
	Future<Response<List<Pet>>> findPetsByStatus({@Query('status') @required List<String> status});

	///Finds Pets by tags  
	///@param tags Tags to filter by
	@Get(path: '/pet/findByTags')
	Future<Response<List<Pet>>> findPetsByTags({@Query('tags') @required List<String> tags});
  ...
  @FactoryConverter(request: FormUrlEncodedConverter.requestFactory)
	Future<Response> updatePetWithForm({@Path('petId') @required int petId, @Field('name')  String name, @Field('status')  String status});
  ...
  @FactoryConverter(request: FormUrlEncodedConverter.requestFactory)
	Future<Response> uploadFile({@Path('petId') @required int petId, @Field('additionalMetadata')  String additionalMetadata, @Field('file')  List<int> file});
	...
	@Get(path: '/user/login')
	Future<Response<String>> loginUser({@Query('username') @required String username, @Query('password') @required String password});
	...
	Future<Response> updateUser({@Path('username') @required String username, @Body() @required String body});
