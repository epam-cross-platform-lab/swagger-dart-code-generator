...
abstract class ExampleSwagger extends ChopperService {
  ...
  @Post(path: '/pet')
  Future<chopper.Response<PetPost$ResponseDto>> petPost(
      {@Body() required PetDto? body});

  ///Update an existing pet
  ///@param body Pet object that needs to be added to the store
  @Put(path: '/pet')
  Future<chopper.Response> petPut({@Body() required PetDto? body});

  ///Finds Pets by status
  ///@param status Status values that need to be considered for filter
  ///@param color Status values that need to be considered for filter
  Future<chopper.Response<List<PetDto>>> petFindByStatusGet(
      {required enums.PetFindByStatusGetStatus? status,
      required enums.PetFindByStatusGetColor? color}) {
    return _petFindByStatusGet(
        status: enums.$PetFindByStatusGetStatusMap[status],
        color: enums.$PetFindByStatusGetColorMap[color]);
  }
  ...
  Future<chopper.Response<List<PetDto>>> _petFindByStatusGet(
      {@Query() required String? status, @Query() required String? color});

  ///Finds Pets by tags
  ///@param tags Tags to filter by
  @Get(path: '/pet/findByTags')
  Future<chopper.Response<List<PetDto>>> petFindByTagsGet(
      {@Query() required List<String>? tags});

  ///Find pet by ID
  ///@param petId ID of pet to return
  @Get(path: '/pet/{petId}')
  Future<chopper.Response<PetDto>> petPetIdGet(
  ...
  Future<chopper.Response<ApiResponseDto>> petPetIdUploadImagePost(
      {@Path('petId') required int? petId,
  ...
  Future<chopper.Response<OrderWithDashDto>> storeOrderPost(
      {@Body() required OrderDto? body});

  ///Find purchase order by ID
  ///@param orderId ID of pet that needs to be fetched
  @Get(path: '/store/order/{orderId}')
  Future<chopper.Response<OrderDto>> storeOrderOrderIdGet(
  ...
  Future<chopper.Response<UserDto>> userUsernameGet(
