...
const aaa = '''
{
  "swagger": "2.0",
  "info": {
    "title": "OMW Notification Service",
    "description": "Interface methods for the omw notification service",
    "version": "V1"
  },
  "host": "localhost:8080",
  "schemes": [
  ...
  "paths": {
    "/omwnotification/v1/callhomeservice/device/{cpeId}/{action}/syncProfile": {
      "post": {
        "summary": "Publishes notification to a MQTT topic",
        "externalDocs": {
          "description": "Publishes notification to a MQTT topic"
        },
        "parameters": [
          {
            "name": "cpeId",
          ...
          },
          {
            ...
            "description": "action can be either notify or notifyAsync"
          },
          {
            "name": "application",
            "in": "path",
            "required": true,
            "type": "string",
            "description": "this is the payload that is published to a topic on MQTT"
          }
        ],
        "responses": {
          "200": {
            "description": "Sucessfully published to MQTT."
          },
          "400": {
            "description": "Malformed request"
          },
          "500": {
            "description": "Internal server communication error with MQTT"
          }
        }
      }
    },
    "/omwnotification/v1/callhomeservice/device/{cpeId}/{action}/cnr": {
      "post": {
        "summary": "Publishes notification to a MQTT topic",
        "externalDocs": {
          "description": "Publishes notification to a MQTT topic"
        ...
        "parameters": [
          ...
          },
          {
            ...
            "required": true,
            "type": "string",
            "description": "this becomes part of the payload that is published to a topic on MQTT"
          },
          {
            "name": "payload",
            "in": "body",
            ...
            "description": "this is data part of the payload that is published to a topic on MQTT"
          }
        ],
        "responses": {
          "200": {
            "description": "Successfully published to MQTT"
          },
          "400": {
            "description": "Malformed request"
          },
