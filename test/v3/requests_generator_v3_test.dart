...
void main() {
  final SwaggerRequestsGeneratorV3 _generator = SwaggerRequestsGeneratorV3();
  ...
  group('Tests for additional methids', () {
    ...
    test('Should get parameter summary', () {
      ...
      final String result =
          _generator.createSummaryParameters(name, description);
...
"""));
  ...
  group('Tests for getReturnTypeName', () {
    ...
    test('Should generate return type by content -> first -> ref', () {
      final String result = _generator.getReturnTypeName(
          <SwaggerResponse>[
