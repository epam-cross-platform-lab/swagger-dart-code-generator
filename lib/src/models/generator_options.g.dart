...
GeneratorOptions _$GeneratorOptionsFromJson(Map json) => GeneratorOptions(
      ...
      additionalHeaders: (json['additional_headers'] as List<dynamic>?)
              ?.map((e) => AdditionalHeadersMap.fromJson(
                  Map<String, dynamic>.from(e as Map)))
              .toList() ??
          [],
    );
...
AdditionalHeadersMap _$AdditionalHeadersMapFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$AdditionalHeadersMapToJson(
        AdditionalHeadersMap instance) =>
    <String, dynamic>{
      'path': instance.path,
      'additional_headers': instance.additionalHeaders,
    };
