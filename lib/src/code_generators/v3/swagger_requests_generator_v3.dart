  ...
  String _getParameterContent(
    ...
    switch (parameter.inParameter) {
      ...
      default:
        ...
        return "@${parameter.inParameter.capitalize}('${parameter.name}') ${parameter.isRequired ? "@required" : ""} ${getParameterTypeName(parameterType, parameter.items?.type)} ${validateParameterName(parameter.name)}";
    }
  }
