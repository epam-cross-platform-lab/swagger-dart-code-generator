...
abstract class SwaggerModelsGenerator {
  ...
  String generatePropertyContentByDefault(
    ...
    const debugComment = '\t// Generated by generatePropertyContentByDefault()\n';

    final jsonKeyContent =
        "@JsonKey(name: '$propertyName'$includeIfNullString$dateToJsonValue$unknownEnumValue)\n";
    return '$debugComment\t$jsonKeyContent\tfinal $typeName ${SwaggerModelsGenerator.generateFieldName(propertyName)};';
  }
  ...
  String generatePropertyContentBySchema(
    ...
    const debugComment = '\t// Generated by generatePropertyContentBySchema()\n';
  ...
  String generatePropertyContentByRef(
    ...
    const debugComment = '\t// Generated by generatePropertyContentByRef()\n';
  ...
  String generateListPropertyContent(
    ...
    const debugComment = '\t// Generated by generateListPropertyContent()\n';

    if (required) {
      return '$debugComment$jsonKeyContent  final List<$typeName> ${SwaggerModelsGenerator.generateFieldName(propertyName)};';
    }
  ...
  String generateGeneralPropertyContent(
    ...
    const debugComment = '\t// Generated by generateGeneralPropertyContent()\n';
