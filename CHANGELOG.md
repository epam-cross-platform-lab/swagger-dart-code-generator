...
- Bumped some dependencies, dart_style was giving strong constraints
...
- **_Breaking_** Added support of Chopper 8.0
...
- **_Breaking_** Added ability to rename downloaded swagger files ([#558](https://github.com/epam-cross-platform-lab/swagger-dart-code-generator/issues/558))
...
- **_Breaking_** Changed Overriden Models usage ([#550](https://github.com/epam-cross-platform-lab/swagger-dart-code-generator/issues/550))
...
- Code refactoring
- **_Breaking_** Changed naming of Responses, RequestBodies
...
- **_Breaking_** Changed String path to Uri in Chopper lib ([#515](https://github.com/epam-cross-platform-lab/swagger-dart-code-generator/issues/515))
...
- **_Breaking_** Removed `use_default_null_for_lists` option
